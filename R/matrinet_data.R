#' @title Test title
#' @param datalist	 A dataframe or list of group (cancer) dataframes containing target gene variables as column vectors. Additional variables (e.g. sampleIDs) could be included, target genes/proteins are extracted automatically from the dataframe by the column names of prior_topology object
#' @param quantiles A dataframe or list of cancer-specific gene expression discretization levels for each gene.
#' @param genenams A character vector of target gene names
#'
...
matrinet_data <- function(datalist, quantiles, genenams){
